...
>
> _Exceto o `star_schema` que é armazenado na pasta de input, pois será consumido na próxima etapa._
...
>
> _Escolho salvar com essa extensão por já ter o modelo semântico e scrips TDML separados para facilitar na documentação._
